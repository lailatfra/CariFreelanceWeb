...
@section('title', 'Jasa Copywriting dan Penulisan Konten Terbaik - CariFreelance') 
@section('content') 
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Jasa Copywriting dan Penulisan Konten Terbaik - CariFreelance</title>
...
<body>
    ...
    <div class="nav-container" id="navigation">
        <nav class="nav">
            <ul class="nav-list">
                ...
                <li class="nav-item active"><a href="/penulisan" class="nav-link">Penulisan & Penerjemahan</a></li>
    ...
    <div class="breadcrumb">
        <div class="breadcrumb-container">
            ...
            <a href="#" class="breadcrumb-link">Penulisan & Penerjemahan</a>
            <span class="breadcrumb-separator">›</span>
            <span class="breadcrumb-current">Copywriting</span>
        </div>
    </div>
    ...
    <div class="main-container">
        <!-- Page Title -->
        <h1 class="page-title">Jasa Copywriting dan Penulisan Konten Terbaik</h1>

        <!-- Category Filters -->
        <div class="category-filters">
            <button class="filter-btn active">semua</button>
            <button class="filter-btn">Website Copy</button>
            <button class="filter-btn">Sales Letter</button>
            <button class="filter-btn">Email Marketing</button>
            <button class="filter-btn">Artikel Blog</button>
            <button class="filter-btn">Product Description</button>
            <button class="filter-btn">Landing Page</button>
            <button class="filter-btn">Social Media</button>
            <button class="filter-btn">Press Release</button>
            <button class="filter-btn">Content Marketing</button>
            <button class="filter-btn strikethrough">Ads Copy</button>
        ...
        <!-- Stats Bar -->
        <div class="stats-bar">
            <div>Pekerjaan yang ditemukan 2.843 Item</div>
        ...
        <div class="job-grid">
            ...
            <article class="job-card">
                <div class="job-card-content">
                    <div class="freelancer-info">
                        ...
                        <div>
                            <div class="freelancer-name">writerpro</div>
                            <div class="response-time">Membalas dalam 5 menit</div>
                        </div>
                    </div>
                    <img src="https://images.unsplash.com/photo-1586717799252-bd134ad00e26?w=400&h=200&fit=crop" alt="Copywriting Services" class="job-image">
                    <h3 class="job-title">Jasa Copywriting Website, Sales Letter, Email Marketing & Content Marketing</h3>
                    <p class="job-stats">Terjual 324 | <span class="rating">★ 4,9</span> (189)</p>
            ...
            <article class="job-card">
                <div class="job-card-content">
                    <div class="freelancer-info">
                        ...
                        <div>
                            <div class="freelancer-name">contentcreator</div>
                            <div class="response-time">Membalas dalam 12 menit</div>
                        </div>
                    </div>
                    <img src="https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?w=400&h=200&fit=crop" alt="Content Writing" class="job-image">
                    <h3 class="job-title">JASA PENULISAN ARTIKEL BLOG & CONTENT MARKETING BERKUALITAS</h3>
                    <p class="job-stats">Terjual 156 | <span class="rating">★ 4,8</span> (87)</p>
                    <div class="job-badges">
                        <span class="badge badge-rehire">Banyak rehire</span>
                        <span class="badge badge-gradual">Bayar Bertahap</span>
                    </div>
                    <p class="job-price">Mulai<br>Rp75.000</p>
                </div>
            </article>
            ...
            <article class="job-card">
                <div class="job-card-content">
                    <div class="freelancer-info">
                        ...
                        <div>
                            <div class="freelancer-name">copyexpert</div>
                            <div class="response-time">Membalas dalam 7 menit</div>
                        </div>
                    </div>
                    <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=400&h=200&fit=crop" alt="Sales Copy" class="job-image">
                    <h3 class="job-title">Sales Copy & Landing Page Copy yang Mengkonversi untuk Bisnis Online</h3>
                    <p class="job-stats">Terjual 89 | <span class="rating">★ 5,0</span> (45)</p>
                    <div class="job-badges">
                        <span class="badge badge-rehire">Banyak rehire</span>
                    </div>
                    <p class="job-price">Mulai<br>Rp300.000</p>
                </div>
            </article>
            ...
            <article class="job-card">
                <div class="job-card-content">
                    <div class="freelancer-info">
                        <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=64&h=64&fit=crop&crop=face" alt="Profile picture" class="freelancer-avatar">
                        <div>
                            <div class="freelancer-name">socialwriter</div>
                            <div class="response-time">Membalas dalam 15 menit</div>
                        </div>
                    </div>
                    <img src="https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=400&h=200&fit=crop" alt="Social Media Content" class="job-image">
                    <h3 class="job-title">Jasa Penulisan Konten Media Sosial, Caption IG, FB & Content Plan</h3>
                    <p class="job-stats">Terjual 267 | <span class="rating">★ 4,9</span> (134)</p>
                    <div class="job-badges">
                        <span class="badge badge-gradual">Bayar Bertahap</span>
                    </div>
