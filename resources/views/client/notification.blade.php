...
<head>
    ...
    <style>
        * {
        ...
        .notif-icon.proposal { background: #dbeafe; color: #1d4ed8; }
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h1>Notifikasi</h1>
            <p>Pantau semua aktivitas proyek Anda</p>
        </div>
        ...
        <div class="notification-list">
            ...
            <div class="notification {{ !$notification->is_read ? 'unread' : '' }}" data-id="{{ $notification->id }}">
                <div class="notif-content">
                    @if($notification->type === 'proposal_received')
                        @php
                            ...
                            $avatar = $user && $user->freelancerProfile && $user->freelancerProfile->profile_picture 
                                ...
                                : 'https://ui-avatars.com/api/?name=' . urlencode($user->name ?? 'User') . '&background=1d9bf0&color=fff';
                        @endphp
                    ...
                    @else
                        <div class="notif-icon {{ $notification->icon_wrapper_class }}">
                    ...
                    <div class="notif-body">
                        ...
                        <div class="notif-footer">
                            ...
                            <div class="notif-actions">
                                ...
                                <a href="{{ $notification->action_url }}" class="btn-action">Lihat</a>
                                @endif
            ...
            <div class="empty-state">
                ...
                <p>Notifikasi akan muncul di sini saat ada aktivitas baru</p>
            </div>
            @endforelse
        </div>
