...
@section('title', 'Web & App - CariFreelance')
@section('content')
...
<head>
    ...
    <title>Web & App - CariFreelance</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .hero {
            background: 
                ...
                url('https://images.unsplash.com/photo-1517180102446-f3ece451e9d8?w=1920&h=1080&fit=crop&crop=center') center/cover;
            min-height: 350px;
            display: flex;
            align-items: center;
            position: relative;
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Web & App</h1>
            <p>Temukan layanan terbaik untuk kebutuhan website dan aplikasi Anda</p>
        </div>
    </section>
    ...
    <div class="main-layout">
        ...
        <main class="content-area">
            <div class="content-header">
                <h2 class="content-title">Web & App Services</h2>
                <p class="content-subtitle">Layanan pengembangan website dan aplikasi yang profesional untuk berbagai kebutuhan bisnis Anda</p>
            </div>

            <!-- Categories Grid - Only 4 Categories -->
            <div class="categories-grid animate-on-scroll">
                <div class="category-card" onclick="navigateToCategory('website-development')">
                    <a href="#" class="category-link">
                        <img src="https://images.unsplash.com/photo-1547658719-da2b51169166?w=500&h=300&fit=crop" alt="Website Development" class="category-image">
                        <div class="category-overlay">
                            <h3 class="category-title">Website Development</h3>
                            <p class="category-description">Pembuatan website profesional dan modern</p>
                        </div>
                    </a>
                </div>

                <div class="category-card" onclick="navigateToCategory('ecommerce-development')">
                    <a href="#" class="category-link">
                        <img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=500&h=300&fit=crop" alt="E-commerce Development" class="category-image">
                        <div class="category-overlay">
                            <h3 class="category-title">E-commerce Development</h3>
                            <p class="category-description">Toko online dan marketplace</p>
                        </div>
                    </a>
                </div>

                <div class="category-card" onclick="navigateToCategory('mobile-app')">
                    <a href="#" class="category-link">
                ...
                <div class="category-card" onclick="navigateToCategory('ui-ux-design')">
                    <a href="#" class="category-link">
                        <img src="https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=500&h=300&fit=crop" alt="UI/UX Design" class="category-image">
                        <div class="category-overlay">
                            <h3 class="category-title">UI/UX Design</h3>
                            <p class="category-description">Desain antarmuka pengguna yang menarik</p>
                        </div>
                    </a>
                </div>
            </div>
