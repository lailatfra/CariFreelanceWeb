...
@section('title', 'Video Editing - CariFreelance')
@section('content')
...
<head>
    ...
    <title>Video Editing - CariFreelance</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .hero {
            background: 
                ...
                url('https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=1920&h=1080&fit=crop&crop=center') center/cover;
            min-height: 350px;
            display: flex;
            align-items: center;
            position: relative;
...
.nav-item.active .nav-link {
    ...
    text-shadow: 0 0 10px rgba(29, 161, 242, 0.6);
        ...
        /* Categories Grid - 2x1 Layout for Video Editing */
        .categories-grid {
            display: grid;
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Video Editing</h1>
            <p>Layanan editing video profesional untuk semua kebutuhan multimedia Anda</p>
        </div>
    </section>
    ...
    <div class="main-layout">
        ...
        <main class="content-area">
            <div class="content-header">
                <h2 class="content-title">Video Editing</h2>
                <p class="content-subtitle">Layanan editing video profesional dan color grading untuk menghasilkan konten berkualitas tinggi</p>
            </div>

            <!-- Categories Grid -->
            <div class="categories-grid animate-on-scroll">
                <div class="category-card" onclick="navigateToCategory('video-editing')">
                    <a href="#" class="category-link">
                        ...
                        <div class="category-overlay">
                            ...
                            <p class="category-description">Editing video profesional untuk semua jenis konten</p>
                        </div>
                    </a>
                </div>

                <div class="category-card" onclick="navigateToCategory('color-grading')">
                    <a href="#" class="category-link">
                        <img src="https://images.unsplash.com/photo-1478720568477-152d9b164e26?w=500&h=300&fit=crop" alt="Color Grading" class="category-image">
                        <div class="category-overlay">
                            <h3 class="category-title">Color Grading</h3>
                            <p class="category-description">Koreksi warna dan grading untuk tampilan sinematik</p>
                        </div>
                    </a>
                </div>
            </div>
