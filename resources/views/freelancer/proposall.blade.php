                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="skills-container" id="skillsContainer">
                            <span class="skill-tag">Contoh Skill 1</span>
                        </div>
...
• Saya bisa mulai mengerjakan dalam 1-2 hari"></textarea>
        ...
        <script>
            ...
            // Skills management - Fixed version
            let skills = ['Contoh Skill 1'];
            ...
            function updateSkillsInput() {
                ...
                // Create new hidden input with comma-separated values
                const input = document.createElement('input');
                input.type = 'hidden';
                input.name = 'skills';
                input.value = skills.join(','); // Join as comma-separated string
                document.getElementById('proposalForm').appendChild(input);
            }

            // Fixed skills input handler
    ...
    `;
            ...
            document.getElementById('proposalForm').addEventListener('submit', function(e) {
                ...
                // Submit form normally (remove preventDefault for actual submission)
                this.submit();
            });
