    ...
    <header class="clean-header">
        <div class="container">
            <nav class="clean-navbar d-flex justify-content-between align-items-center">
                {{-- Logo --}}
                <a href="/home/freelancer" class="brand-logo">
                ...
                <div class="header-actions">
                    ...
                    <div class="desktop-actions d-none d-md-flex align-items-center" style="gap: 1rem;">
                        {{-- Notifications --}}
                        <a href="/notification/freelancer">
        ...
        @endif
                    ...
                    <div class="profile-container dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="profileDropdown">
                            <li>
                                <a class="dropdown-item" href="{{ route('profile-freelancer') }}">
                                    <i class="fas fa-user"></i>
                                    Profil Saya
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('freelancer-profile-akun') }}">
