...
<head>
    ...
    <title>Akun Pending - CariFreelance</title>
...
<section class="verification-section">
    <div class="verification-container">
        <div class="verification-card">
            ...
            <h1 class="verification-title">Pendaftaran yang Anda ajukan sedang menunggu persetujuan admin.</h1>
            
            <p class="verification-message">
Silakan pantau notifikasi melalui email, karena Anda akan menerima pemberitahuan setelah proposal disetujui.
                Terima kasih telah mendaftar di <b>CariFreelance</b>.<br>
                Saat ini akunmu masih <b>pending</b> dan akan segera ditinjau oleh admin.<br>
                Mohon tunggu sampai admin melakukan persetujuan agar kamu bisa mulai menggunakan platform ini.
            </p>
            ...
            <div class="email-tips">
                ...
                <ul>
                    <li>Proses approval biasanya memakan waktu maksimal 1x24 jam</li>
                    <li>Kamu akan mendapatkan notifikasi setelah akun disetujui</li>
                    <li>Pastikan data profil yang kamu isi sudah lengkap dan benar</li>
                    <li>Hubungi support jika akunmu belum disetujui dalam waktu lebih dari 24 jam</li>
                </ul>
            </div>
