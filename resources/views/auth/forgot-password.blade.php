...
<head>
    ...
    <title>Lupa Password - CariFreelance</title>
    ...
    <style>
        * {
        ...
        .back-login-link {
            ...
            margin-top: 25px;
            padding-bottom: 10px;
            animation: linkFloat 0.8s ease-out 0.7s both;
        }
...
<body>
                ...
                <div class="col-lg-6">
                    <div class="welcome-section h-100">
                        ...
                        <div class="welcome-text">
                            ...
                            <p>Jangan khawatir! Masukkan email yang terdaftar dan kami akan mengirimkan link untuk mengatur ulang kata sandi Anda. Akses kembali akun CariFreelance Anda dengan mudah.</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('CariFreelance Forgot Password Page - Enhanced Interactive Features Loaded');
        });
    </script>
</body>
</html>